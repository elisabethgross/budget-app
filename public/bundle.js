...
/***/ function(module, exports, __webpack_require__) {
	...
	function transactions() {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialTransactions;
	  var action = arguments[1];
	
	  switch (action.type) {
	    case _transactions.RECEIVE_TRANSACTIONS:
	      return action.transactions;
	    case _transactions.RECEIVE_TRANSACTION:
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.addTransaction = exports.fetchTransactions = exports.receiveTransaction = exports.receiveTransactions = exports.RECEIVE_TRANSACTION = exports.RECEIVE_TRANSACTIONS = undefined;
	...
	var RECEIVE_TRANSACTION = exports.RECEIVE_TRANSACTION = 'RECEIVE_TRANSACTION';
	
	var receiveTransactions = exports.receiveTransactions = function receiveTransactions(transactions) {
	  return {
	...
	var receiveTransaction = exports.receiveTransaction = function receiveTransaction(transaction) {
	  return {
	...
	var fetchTransactions = exports.fetchTransactions = function fetchTransactions() {
	  return function (dispatch) {
	    return fetch('/api/transactions').then(function (res) {
	      return res.json();
	...
	var addTransaction = exports.addTransaction = function addTransaction(transaction) {
	  return function (dispatch) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(_CreateCategoryContainer2.default, null)
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    addDaTransaction: function addDaTransaction(transaction) {
	      dispatch((0, _transactions.addTransaction)(transaction));
	    }
	  };
	};
	
	var AddTransactionsContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_AddTransactions2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CategoriesListContainer = __webpack_require__(229);
	
	var _CategoriesListContainer2 = _interopRequireDefault(_CategoriesListContainer);
	...
	var AddTransaction = function (_Component) {
	  ...
	  function AddTransaction() {
	    ...
	    var _this = _possibleConstructorReturn(this, (AddTransaction.__proto__ || Object.getPrototypeOf(AddTransaction)).call(this));
	  ...
	  _createClass(AddTransaction, [{
	    ...
	    value: function render() {
	      ...
	      var addDaTransaction = this.props.addDaTransaction;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('br', null),
	        _react2.default.createElement(_CategoriesListContainer2.default, null),
	        _react2.default.createElement(
	          'button',
	          { type: 'submit' },
	          'Add Transaction'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TransactionsListContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_TransactionsList2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Total = __webpack_require__(224);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CreateCategory = function (_Component) {
	  ...
	  function CreateCategory() {
	    ...
	    var _this = _possibleConstructorReturn(this, (CreateCategory.__proto__ || Object.getPrototypeOf(CreateCategory)).call(this));
	        ...
	        _react2.default.createElement(
	          'button',
	          {
	            onClick: function onClick() {
	              _this2.props.addDaCategory({
	                name: _this2.state.categoryName
	              });
	              _this2.refs.category.value = _this2.refs.category.defaultValue;
	            } },
	          'Add Category'
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	function categories() {
	  ...
	  switch (action.type) {
	    case _categories.RECEIVE_CATEGORIES:
	      return action.categories;
	    case _categories.RECEIVE_CATEGORY:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addCategory = exports.addCategory = function addCategory(category) {
	  return function (dispatch) {
	    return _axios2.default.post('/api/categories', {
	      name: category.name
	    }).then(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CreateCategory = __webpack_require__(225);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    addDaCategory: function addDaCategory(category) {
	      dispatch((0, _categories.addCategory)(category));
	    }
	  };
	};
	
	var CreateCategoryContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_CreateCategory2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CategoriesList = __webpack_require__(230);
	...
	var CategoriesListContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_CategoriesList2.default);
